...
//    int counter = 0;
//    EXPECT_EQ(Formulas::F2_recursion(counter, 1), 1);
//    EXPECT_EQ(Formulas::F2_recursion(counter, 2), 2);
//}
//
//TEST(F2_RecursiveTest, EvenNumber) {
//    int counter = 0;
//    EXPECT_EQ(Formulas::F2_recursion(counter, 4), 25);
//}
//
//TEST(F2_RecursiveTest, OddNumber) {
//    int counter = 0;
//    EXPECT_EQ(Formulas::F2_recursion(counter, 3), 11);
//}
//
...
//    EXPECT_EQ(Formulas::F2_loop(4), 25); // По вашей реализации
//}
//
//TEST(F2_LoopTest, OddNumber) {
//    EXPECT_EQ(Formulas::F2_loop(3), 11); // По вашей реализации
//}
//
...
//    int counter = 0;
//    EXPECT_EQ(Formulas::F9_recursion(counter, 3), 4);
//}
//
...
//    EXPECT_EQ(Formulas::F9_loop(5), 13);
//}
//
//// Остальные тесты
